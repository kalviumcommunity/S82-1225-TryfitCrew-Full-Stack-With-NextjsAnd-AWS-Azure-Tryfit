...
export default function FashionShopPage() {
  ...
  const productsData = [
    // --- GEN Z DRESSES ---
    { id: 701, name: 'Y2K Mesh Mini Dress', price: 45.00, rating: 4.8, reviews: '520', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1605763240004-7e93b172d754?q=80&w=400&auto=format&fit=crop' },
    { id: 702, name: 'Cut-Out Midi Dress', price: 65.00, rating: 4.9, reviews: '800', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=400&auto=format&fit=crop' },
    { id: 703, name: 'Cybercore Bodycon', price: 55.00, rating: 4.7, reviews: '340', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1616847220556-3b6b47c030eb?q=80&w=400&auto=format&fit=crop' },
    { id: 704, name: 'Cottagecore Puff Dress', price: 72.00, rating: 4.6, reviews: '210', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?q=80&w=400&auto=format&fit=crop' },
    { id: 705, name: 'Satin Slip Dress', price: 40.00, rating: 5.0, reviews: '150', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?q=80&w=400&auto=format&fit=crop' },
    { id: 706, name: 'Grunge Plaid Dress', price: 38.00, rating: 4.5, reviews: '400', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?q=80&w=400&auto=format&fit=crop' },
    { id: 707, name: 'Denim Overall Dress', price: 52.00, rating: 4.7, reviews: '300', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1591369045385-115fe25d718b?q=80&w=400&auto=format&fit=crop' },
    { id: 708, name: 'Velvet Ruched Mini', price: 48.00, rating: 4.8, reviews: '180', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1574621100236-d25b64cfd647?q=80&w=400&auto=format&fit=crop' },
    { id: 709, name: 'Asymmetric Knit Dress', price: 60.00, rating: 4.6, reviews: '600', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?q=80&w=400&auto=format&fit=crop' },
    { id: 710, name: 'Neon Summer Dress', price: 35.00, rating: 4.9, reviews: '250', cat: 'Dresses', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1609357602123-5e921d4df7df?q=80&w=400&auto=format&fit=crop' },

    // --- GEN Z OUTERWEAR ---
    { id: 101, name: 'Oversized Varsity Jacket', price: 89.00, rating: 4.9, reviews: '2.3k', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?q=80&w=400&auto=format&fit=crop' },
    { id: 102, name: 'Cropped Puffer', price: 75.50, rating: 4.7, reviews: '850', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=400&auto=format&fit=crop' },
    { id: 103, name: 'Matrix Leather Coat', price: 110.00, rating: 4.8, reviews: '500', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1520975661595-6453be3f7070?q=80&w=400&auto=format&fit=crop' },
    { id: 104, name: 'Distressed Denim Jacket', price: 65.00, rating: 4.9, reviews: '1.1k', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1545594861-3bef43ff2288?q=80&w=400&auto=format&fit=crop' },
    { id: 105, name: 'Racing Bomber Jacket', price: 95.00, rating: 5.0, reviews: '320', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1605763240004-7e93b172d754?q=80&w=400&auto=format&fit=crop' },
    { id: 106, name: 'Fuzzy Bucket Hat & Coat', price: 85.00, rating: 4.6, reviews: '410', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1578978738328-91e843f5505d?q=80&w=400&auto=format&fit=crop' },
    { id: 107, name: 'Techwear Windbreaker', price: 75.00, rating: 4.5, reviews: '200', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1605763240004-7e93b172d754?q=80&w=400&auto=format&fit=crop' },
    { id: 108, name: 'Patchwork Cardigan', price: 55.00, rating: 4.8, reviews: '600', cat: 'Outerwear', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?q=80&w=400&auto=format&fit=crop' },

    // --- GEN Z TOPS ---
    { id: 201, name: 'Baby Tee "Angel"', price: 25.00, rating: 4.8, reviews: '900', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=400&auto=format&fit=crop' },
    { id: 202, name: 'Mesh Long Sleeve', price: 30.00, rating: 4.9, reviews: '3.5k', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1620799140408-ed5341cd2431?q=80&w=400&auto=format&fit=crop' },
    { id: 203, name: 'Graphic Oversized Hoodie', price: 60.00, rating: 4.7, reviews: '750', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?q=80&w=400&auto=format&fit=crop' },
    { id: 204, name: 'Corset Top', price: 45.00, rating: 4.6, reviews: '400', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1564257631407-4deb1f99d992?q=80&w=400&auto=format&fit=crop' },
    { id: 205, name: 'Ribbed Tank', price: 20.00, rating: 5.0, reviews: '1.2k', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1503342394128-c104d54dba01?q=80&w=400&auto=format&fit=crop' },
    { id: 206, name: 'Cropped Knit Sweater', price: 42.00, rating: 4.5, reviews: '300', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1574201635302-388dd92a4c3f?q=80&w=400&auto=format&fit=crop' },
    { id: 207, name: 'Tie-Dye Tube Top', price: 22.00, rating: 4.7, reviews: '150', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=400&auto=format&fit=crop' },
    { id: 208, name: 'Sheer Layering Top', price: 28.00, rating: 4.8, reviews: '620', cat: 'Tops', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1602574044810-6395dc898d9e?q=80&w=400&auto=format&fit=crop' },

    // --- GEN Z BOTTOMS ---
    { id: 301, name: 'Low-Rise Baggy Jeans', price: 55.00, rating: 4.8, reviews: '2.1k', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=400&auto=format&fit=crop' },
    { id: 302, name: 'Parachute Cargo Pants', price: 62.00, rating: 4.9, reviews: '800', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?q=80&w=400&auto=format&fit=crop' },
    { id: 303, name: 'Micro Mini Skirt', price: 35.00, rating: 4.7, reviews: '550', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1516575150278-77136aed6920?q=80&w=400&auto=format&fit=crop' },
    { id: 304, name: 'Carpenter Jeans', price: 58.00, rating: 5.0, reviews: '1.5k', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1582552938357-32b906df40cb?q=80&w=400&auto=format&fit=crop' },
    { id: 305, name: 'Pleated Tennis Skirt', price: 32.00, rating: 4.6, reviews: '300', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?q=80&w=400&auto=format&fit=crop' },
    { id: 306, name: 'Camo Cargo Pants', price: 48.00, rating: 4.7, reviews: '900', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?q=80&w=400&auto=format&fit=crop' },
    { id: 307, name: 'Biker Shorts', price: 25.00, rating: 4.5, reviews: '210', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1506619216599-9d16d0903dfd?q=80&w=400&auto=format&fit=crop' },
    { id: 308, name: 'Distressed Jorts', price: 45.00, rating: 4.8, reviews: '450', cat: 'Bottoms', gender: 'Gen Z', img: 'https://images.unsplash.com/photo-1565084888279-aca607ecce0c?q=80&w=400&auto=format&fit=crop' },
    ...
    { id: 604, name: 'Oversized Sweatshirt', price: 55.00, rating: 4.8, reviews: '600', cat: 'Tops', gender: 'Men', img: 'https://images.unsplash.com/photo-1614777735430-7b46df56b404?q=80&w=400&auto=format&fit=crop' },
  ...
  return (
    <div className="shop-page">
      ...
      {/* --- Hero --- */}
      <div className="hero">
        <h1 className="hero-title">{activeCategory === 'All Product' ? 'Shop' : activeCategory}</h1>
      </div>
